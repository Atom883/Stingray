    ...
    useEffect(() => {
        const handleKeyDown = (event: KeyboardEvent) => {
            ...
            if (event.key === "ArrowLeft") {
                ...
                // スペースキーでアルファベットを捕まえる
                if (caughtAlphabet) {
                    setCaughtAlphabets(prevCaughtAlphabets => [...prevCaughtAlphabets, caughtAlphabet]); // 捕まえたアルファベットを記録
                    setCaughtAlphabet(null); // caughtAlphabetをリセットする
                    setAlphabets(alpfabet => alpfabet.filter(alphabet => alphabet.char !== caughtAlphabet.char));
                }
            }
        };
