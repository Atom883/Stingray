  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 style={{ marginBottom: "35px", color: "#222", fontSize: "1.8rem", fontWeight: "bold"  }}>
            Customize "A"
          </h2>

          {/* ▼ フォント選択 */}
          <div style={{ marginBottom: "20px" }}>
            <label style={{ fontSize: "1.2rem",marginRight: "8px" }}>Font:</label>
            <select
              value={fontFamily}
          ...
          {/* ▼ 色選択 */}
          <div style={{ marginBottom: "20px" }}>
            <label style={{ fontSize: "1.2rem",marginRight: "8px" }}>Color:</label>
            <select
              value={fontColor}
